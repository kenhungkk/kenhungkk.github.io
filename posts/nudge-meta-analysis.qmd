...
So first of all, we are going to only look at *p*-values that are smaller than $0.05$, and adjust them by division by $0.05$, as in our aforementioned paper, or [Zhao, Small and Su (2018)](https://arxiv.org/abs/1703.09787).
