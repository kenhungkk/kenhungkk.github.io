...
where $p_i$ represent the chance of a patient dying in region $i$. We would then want to provide simultaneous confidence intervals for the rank of region $i$, $r_i$, as defined in @al_mohamad_simultaneous_2022:
$$r_i = 1 + \#\{j \ne i: p_j < p_i\}$$
