...
\item {\em (Rosen 5.2.18; challenging)} Use strong induction to show that when a simply polygon $P$ with consecutive vertices $v_1, v_2, \ldots, v_n$ is tringulated into $n-2$ triangles, the triangles can be numbered $1, 2, \ldots, n-2$ such that $v_i$ is a vertex of triangle $i$ for $i = 1, 2, \ldots, n-2$.
