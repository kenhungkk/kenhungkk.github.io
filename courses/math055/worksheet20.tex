...
\item An {\em edge coloring} of a graph is an assignment of colors to the edges so that edges incident with a common vertex are assigned different colors. Show that the highest degree is always greater than the edge chromatic number.
